...
<link href="https://fonts.googleapis.com/css2?family=Kanit:wght@100;200;500&display=swap" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#F2BED1">
        <a class="navbar-brand" href="#" style="color: #fefefe"><svg xmlns="http://www.w3.org/2000/svg"
                width="30" height="30" fill="currentColor" class="bi bi-microsoft-teams" viewBox="0 0 16 16">
                <path
            ...
            </svg></i> <b style="font-size: 25px;">Ms Teams</b></a>
